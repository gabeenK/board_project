...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = -2049541941L;
    ...
    public final ListPath<CommentClaim, QCommentClaim> commentClaims = this.<CommentClaim, QCommentClaim>createList("commentClaims", CommentClaim.class, QCommentClaim.class, PathInits.DIRECT2);

    public final ListPath<CommentFile, QCommentFile> commentFiles = this.<CommentFile, QCommentFile>createList("commentFiles", CommentFile.class, QCommentFile.class, PathInits.DIRECT2);
